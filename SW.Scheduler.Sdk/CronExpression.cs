...
namespace SW.Scheduler.Sdk
{
    ...
    internal static class TimeZoneUtil
    {
        ...
        internal static Func<string, TimeZoneInfo?> CustomResolver = id => null;
        ...
        internal static TimeSpan GetUtcOffset(DateTime dateTime, TimeZoneInfo timeZoneInfo)
        {
        ...
        /// <returns></returns>
        internal static TimeZoneInfo FindTimeZoneById(string id)
        {
    ...
    internal class CronExpression : IDeserializationCallback, ISerializable
    {
        ...
        internal static readonly int MaxYear = DateTime.Now.Year + 100;
        ...
        internal CronExpression(string cronExpression)
        {
        ...
        internal virtual bool IsSatisfiedBy(DateTimeOffset dateUtc)
        {
        ...
        internal virtual DateTimeOffset? GetNextValidTimeAfter(DateTimeOffset date)
        {
        ...
        /// <returns>the next valid date/time</returns>
        internal virtual DateTimeOffset? GetNextInvalidTimeAfter(DateTimeOffset date)
        {
        ...
        ///         expression</returns>
        internal static bool IsValidExpression(string cronExpression)
        {
            try
            {
        ...
        internal static void ValidateExpression(string cronExpression)
        {
            new CronExpression(cronExpression);
        }
        ...
        internal string CronExpressionString { get; }

        /// <summary>
        /// Gets the expression summary.
        /// </summary>
        /// <returns></returns>
        internal virtual string GetExpressionSummary()
        {
        ...
        /// <returns></returns>
        internal virtual DateTimeOffset? GetTimeAfter(DateTimeOffset afterTimeUtc)
        {
        ...
        /// <returns></returns>
        internal virtual DateTimeOffset? GetTimeBefore(DateTimeOffset? endTime)
        {
            // TODO: implement
            return null;
        }
        ...
        /// </summary>
        /// <returns></returns>
        internal virtual DateTimeOffset? GetFinalFireTime()
        {
        ...
        internal bool Equals(CronExpression other)
        {
